    ...
    payslips: {
      ...
      items: {
        ...
        properties: {
          ...
          company: { type: "string", description: "Legal name of the employer paying this payslip" },
        },
        required: [
          "startDate",
          "endDate",
...
export const PROMPT = [
  ...
  "",
  "Read the attached payslip pages and return a JSON object with a `payslips` array. Every payslip row must include ALL nine fields below:",
  "",
  ...
  "- company (string — legal name of the employer paying this payslip, as printed at the top of the document)",
  "",
  "Rules:",
  ...
  "- Use 'Unknown' for `company` only when no employer name is anywhere on the page. Otherwise copy the legal name exactly as printed (e.g. 'ACME PTY LTD').",
