...
const LoginPageInner = function LoginPage() {
  return (
    <Box
      sx={{
    ...
    >
      ...
      >
        <Stack spacing={0.5} sx={{ mb: 3 }}>
          ...
          >
            Sign in to paylips<span style={{ color: palette.mint }}>.</span>aus
          </Typography>
          <Typography sx={{ fontSize: 13, color: palette.textMute, mt: 0.5 }}>
            Use your email or Google account to access your dashboard.
          </Typography>
        </Stack>
        <LoginForm />
        <Box
